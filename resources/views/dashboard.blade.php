                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">RATA-RATA IKD</th>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{asset('template/assets/img/small-logos/pc.jpg')}}" class="avatar avatar-lg me-3" alt="xd">
                          </div>
